...
##Category Netplot
#The cnetplot depicts the linkages of genes and biological concepts (e.g. GO terms or KEGG pathwayhttp://127.0.0.1:39791/graphics/88bf7a0b-6d09-4b33-907e-5bddff6adaa1.pngs) as a network (helpful to see which genes are involved in enriched pathways and genes that may belong to multiple annotation categories).
